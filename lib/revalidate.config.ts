...
export const PAGE_REVALIDATE = {
  ...
  // 리스트 페이지
  NEWS_LIST: REVALIDATE_TIME.LONG,
  NOTICE_LIST: REVALIDATE_TIME.LONG,
  CLOG_LIST: REVALIDATE_TIME.MEDIUM,
  BULLETIN_LIST: REVALIDATE_TIME.MEDIUM,
  SCHEDULE: REVALIDATE_TIME.MEDIUM,

  // 상세 페이지
  DETAIL: REVALIDATE_TIME.LIST,
